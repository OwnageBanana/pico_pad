...
// impl core::iter::FromIterator<Key> for KbHidReport {
...
//     pub fn pressed(&mut self, kc: Key) {
//         use Key::*;
//         match kc {
//             No => (),
